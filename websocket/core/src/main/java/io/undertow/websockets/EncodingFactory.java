...
public class EncodingFactory {
    ...
    public EncodingFactory(final Map<Class<?>, List<ObjectFactory<? extends Encoder>>> binaryEncoders, final Map<Class<?>, List<ObjectFactory<? extends Decoder>>> binaryDecoders, final Map<Class<?>, List<ObjectFactory<? extends Encoder>>> textEncoders, final Map<Class<?>, List<ObjectFactory<? extends Decoder>>> textDecoders) {
    ...
    public static EncodingFactory createFactory(ObjectIntrospecter objectIntrospecter, final Class<? extends Decoder>[] decoders, final Class<? extends Encoder>[] encoders) throws DeploymentException {
        return createFactory(objectIntrospecter, Arrays.asList(decoders), Arrays.asList(encoders));
    }

    public static EncodingFactory createFactory(ObjectIntrospecter objectIntrospecter, final List<Class<? extends Decoder>> decoders, final List<Class<? extends Encoder>> encoders) throws DeploymentException {
        final Map<Class<?>, List<ObjectFactory<? extends Encoder>>> binaryEncoders = new HashMap<>();
        final Map<Class<?>, List<ObjectFactory<? extends Decoder>>> binaryDecoders = new HashMap<>();
        final Map<Class<?>, List<ObjectFactory<? extends Encoder>>> textEncoders = new HashMap<>();
    ...
    private static <T> ObjectFactory<? extends T> createObjectFactory(final ObjectIntrospecter objectIntrospecter, final Class<? extends T> decoder) throws DeploymentException {
