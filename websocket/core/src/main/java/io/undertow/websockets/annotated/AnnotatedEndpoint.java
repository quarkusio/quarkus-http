...
public class AnnotatedEndpoint extends Endpoint {
    ...
    private final ObjectHandle<?> instance;
    ...
    AnnotatedEndpoint(final ObjectHandle<?> instance, final BoundMethod webSocketOpen, final BoundMethod webSocketClose, final BoundMethod webSocketError, final BoundMethod textMessage, final BoundMethod binaryMessage, final BoundMethod pongMessage) {
